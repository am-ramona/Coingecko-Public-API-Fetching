...
export default function CryptoExchangeDetails() {
    ...
    return (
        <section className="details grid padding">
            <code className="center green header grid">Exchange details</code>
            ...
            <ul> <p className='italic'>Social media links:</p>
                ...
                {exchangeDetails.twitter_handle &&
                  <li>
                    <a href={'http://twitter.com/' + exchangeDetails.twitter_handle} rel="noreferrer" target="_blank">
                        Twitter Handle
                    </a>
                    </li>
                }
            ...
            <p> Description: {exchangeDetails?.description.length === 0 ? 'not available' : exchangeDetails.description}</p>
            <button type='button' onClick={routeChange} className='pointer'>Back</button>
        </section>
    );
}
